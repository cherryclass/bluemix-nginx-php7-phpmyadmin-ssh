...
#ssl
#sudo letsencrypt certonly --email contact@cherryclass.net -d gitlab.cherryclass.net -d kanboard.cherryclass.net -d adminer.cherryclass.net -d nextcloud.cherryclass.net -d phpmyadmin.cherryclass.net --standalone
#2
#acces live chown?
